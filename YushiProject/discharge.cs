...
namespace BT2202a
{
    ...
    public class Discharge : TestStep
    {
        ...
        {   // pre run
            var data = new { sleep = 1, test_step = "Discharge", status = "" };
        ...
        public override void Run()
        {
            ...
            try {
                var dataStart = new { sleep = 1, test_step = "Discharge", status = "" };
            ...
            try
            {
                ...
                var data_with_cells = new { sleep = 1, test_step = "Discharge", cell_list = cell_group };
                jsonHelper.jsonAider.write_json(data_with_cells);
